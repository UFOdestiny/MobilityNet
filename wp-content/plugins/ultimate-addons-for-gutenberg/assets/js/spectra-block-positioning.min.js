const UAGBBlockPositioning = {
  ...
  handleSticky(t, e) {
    ...
    let n, a, l, r;
    const c = { top: 0, bottom: 0 },
      d = { top: 0, right: 0, bottom: 0, left: 0 };
    if (e?.UAGStickyRestricted) {
      r = y.getBoundingClientRect();
      const g = window.getComputedStyle(y);
      (d.top = parseInt(g.getPropertyValue("padding-top") || 0, 10)),
        (d.bottom = parseInt(g.getPropertyValue("padding-bottom") || 0, 10)),
        (c.top = r.top + (window.pageYOffset || 0) + d.top),
        (c.bottom =
          r.bottom +
    ...
    "bottom" === e?.UAGStickyLocation
      ...
      : ((n =
        ...
        (l =
          ...
          (t.parentNode.insertBefore(i, t),
          t.classList.add("uagb-position__sticky--stuck"),
          e?.UAGStickyRestricted && l >= c.bottom
            ? (t.classList.remove("uagb-position__sticky--stuck"),
              t.classList.add("uagb-position__sticky--restricted"),
              (t.style.top = ""),
              (t.style.bottom = d.bottom + "px"),
